...
public class Quadtree {
    ...
    private class Node{
        ...
        public Node(Rectangle2f bounds){
            ...
            float newh = h/2f;
            float neww = w/2f;
//            System.out.println("neww: "+neww+" newh: "+newh+" leafsize: "+leafsize);
...
//                (inBounds(element.getPreviousBounds()) && !inBounds(element.getBounds()))
//              ){
                quad1.moved(element);
                quad2.moved(element);
                quad3.moved(element);
...
//                System.out.println("Elements size: "+elements.size()+" alpha "+alpha);
